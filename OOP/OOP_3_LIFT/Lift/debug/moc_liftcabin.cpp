...
void LiftCabin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LiftCabin::FloorAchieved)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LiftCabin::FloorPassed)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (LiftCabin::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LiftCabin::Move)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LiftCabin::AchievedForResetButton)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (LiftCabin::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LiftCabin::cabinStopped)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject LiftCabin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LiftCabin.data,
      qt_meta_data_LiftCabin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LiftCabin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LiftCabin.stringdata0))
        return static_cast<void*>(const_cast< LiftCabin*>(this));
