...
void LiftDoors::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LiftDoors::DoorsClosed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (LiftDoors::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LiftDoors::DoorsOpen)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LiftDoors::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LiftDoors.data,
      qt_meta_data_LiftDoors,  qt_static_metacall, nullptr, nullptr}
};
